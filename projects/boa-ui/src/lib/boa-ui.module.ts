 ...
 *
 * Note: In Angular Material 15, MDC-migrated components use MatLegacy* prefix
 * while the new MDC-based components take the non-prefixed names.
 * Full MDC migration is planned for Phase 2.
 *
