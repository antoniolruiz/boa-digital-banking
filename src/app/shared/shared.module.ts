...
// Angular Material 15 — MDC-migrated components use MatLegacy* prefix
// to preserve pre-MDC behavior while the new MDC components take the non-prefixed names.
// Non-MDC components (icon, toolbar, sidenav, sort, datepicker, badge, divider, expansion) keep original names.
